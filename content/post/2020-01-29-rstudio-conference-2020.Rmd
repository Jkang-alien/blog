...
High dimentionality, MNIST data set PCA clustering.

Fairness, Different view of points can be visualized. People can understand with it.
...
After modeling with R, through application programming interface (API) the model can be used by other application. 

Applications using R and Plumber

T-mobile Heather Nolis, Jacqueline Nolis
'We we're strrictly a java shop'
...
Packaging plumber  
Package as a deploying method  



Alex Gold  RStudio  
Develop public bicycle prediction app  
...
{FlatironKichen}, a package for framework for clinical patient data analysis. A data.frame with one row for one patient. It has its unique data.frame frame and analysis workflow. If once the data.frame is established following analysis becomes easy.  
...
Transfusion platele selection and match for patient and documentation automation  

---
Platele need and bed occupation prediction and its applications
