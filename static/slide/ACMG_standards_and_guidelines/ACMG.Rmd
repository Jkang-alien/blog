---
title: "Interpretation of Sequence Variants"
author: "Jun Kang"
draft: false
output:
...
[Nature 09 November 2022](https://www.nature.com/articles/d41586-022-03577-9)
...
brca2 <- readr::read_csv(here::here("static/slide/ACMG_standards_and_guidelines/data/varinat_data.csv"))

brca2 |>
  dplyr::filter(HGVSc == "c.10150C>T")|>
  knitr::kable()|>
...
# Geuess Pathogenic or Benign 

![](ACMG-figure/BRCA2cmc9076.png)
...
![:scale 80%](ACMG-figure/41436_2015_Article_BFgim201530_Fig1_HTML.webp)
